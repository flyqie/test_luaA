...
function var_0_0.GET_TECHNOLOGY_GROUP_DESC(arg_3_0, arg_3_1, arg_3_2)
	...
	if var_3_0 == GuildConst.TYPE_GOLD_MAX then
		return i18n("guild_tech_gold_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_OIL_MAX then
		return i18n("guild_tech_oil_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_SHIP_BAG then
		return i18n("guild_tech_shipbag_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_EQUIPMENT_BAG then
		return i18n("guild_tech_equipbag_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_CATBOX_GOLD_COST then
		return i18n("guild_box_gold_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_CATBOX_TIME_COST_R then
		return i18n("guidl_r_box_time_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_CATBOX_TIME_COST_SR then
		return i18n("guidl_sr_box_time_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_CATBOX_TIME_COST_SSR then
		return i18n("guidl_ssr_box_time_desc", var_3_1)
	elseif var_3_0 == GuildConst.TYPE_GUILD_MEMBER_CNT then
...
function var_0_0.GET_TECHNOLOGY_DESC(arg_5_0, arg_5_1)
	...
	if var_5_0 == GuildConst.TYPE_GOLD_MAX then
		return i18n("guild_tech_gold_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_OIL_MAX then
		return i18n("guild_tech_oil_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_SHIP_BAG then
		return i18n("guild_tech_shipbag_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_EQUIPMENT_BAG then
		return i18n("guild_tech_equipbag_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_CATBOX_GOLD_COST then
		return i18n("guild_box_gold_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_CATBOX_TIME_COST_R then
		return i18n("guidl_r_box_time_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_CATBOX_TIME_COST_SR then
		return i18n("guidl_sr_box_time_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_CATBOX_TIME_COST_SSR then
		return i18n("guidl_ssr_box_time_desc", arg_5_1)
	elseif var_5_0 == GuildConst.TYPE_GUILD_MEMBER_CNT then
