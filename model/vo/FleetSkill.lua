...
function var_0_0.triggerSkill(arg_7_0, arg_7_1)
	...
	return _.reduce(var_7_0, nil, function(arg_11_0, arg_11_1)
		...
		if var_11_0 == FleetSkill.TypeBattleBuff then
...
function var_0_0.NoneChapterFleetCheck(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_12_0 == FleetSkill.TriggerDDHead then
	...
	elseif var_12_0 == FleetSkill.TriggerNekoPos then
		local var_12_5 = arg_12_0:findCommanderBySkillId(arg_12_1.id)

		for iter_12_0, iter_12_1 in pairs(arg_12_0:getCommanders()) do
			if var_12_5.id == iter_12_1.id and iter_12_0 == arg_12_2[2] then
				return true
			end
		end
	elseif var_12_0 == FleetSkill.TriggerInSubTeam then
		return true
	else
		return false
	end
...
function var_0_0.triggerMirrorSkill(arg_14_0, arg_14_1)
	...
	return _.reduce(var_14_0, nil, function(arg_18_0, arg_18_1)
		...
		if var_18_0 == FleetSkill.TypeBattleBuff then
...
function var_0_0.MirrorFleetCheck(arg_19_0, arg_19_1, arg_19_2)
	...
	if var_19_0 == FleetSkill.TriggerDDHead then
	...
	elseif var_19_0 == FleetSkill.TriggerNekoPos then
		local var_19_5 = arg_19_0:findCommanderBySkillId(arg_19_1.id)

		for iter_19_0, iter_19_1 in pairs(arg_19_0:getCommanders()) do
			if var_19_5.id == iter_19_1.id and iter_19_0 == arg_19_2[2] then
				return true
			end
		end
	elseif var_19_0 == FleetSkill.TriggerInSubTeam then
		return true
	else
		return false
	end
...
function var_0_0.GuildBossTriggerSkill(arg_21_0, arg_21_1)
	...
	return _.reduce(var_21_0, nil, function(arg_25_0, arg_25_1)
		...
		if var_25_0 == FleetSkill.TypeBattleBuff then
...
function var_0_0.GuildBossFleetCheck(arg_26_0, arg_26_1, arg_26_2)
	...
	if var_26_0 == FleetSkill.TriggerDDHead then
	...
	elseif var_26_0 == FleetSkill.TriggerNekoPos then
		local var_26_4 = arg_26_0:findCommanderBySkillId(arg_26_1.id)

		for iter_26_0, iter_26_1 in pairs(arg_26_0:getCommanders()) do
			if var_26_4.id == iter_26_1.id and iter_26_0 == arg_26_2[2] then
				return true
			end
		end
	elseif var_26_0 == FleetSkill.TriggerInSubTeam then
		return true
	else
		return false
	end
