...
slot0 = {
	...
	[SCENE.FEAST] = function (slot0, slot1)
		slot0.mediator = FeastMediator
		slot0.viewComponent = FeastScene
	end,
	...
	[SCENE.VOTESCHEDULE] = function (slot0, slot1)
		slot0.mediator = VoteScheduleMediator
		slot0.viewComponent = VoteScheduleScene
	end,
	[SCENE.VOTEENTRANCE] = function (slot0, slot1)
		slot0.mediator = VoteEntranceMediator
		slot0.viewComponent = VoteEntranceScene
	end,
	[SCENE.CLASS] = function (slot0, slot1)
		slot0.mediator = ClassMediator
		slot0.viewComponent = ClassLayer
	end,
	[SCENE.COMMANDERCAT] = function (slot0, slot1)
		slot0.mediator = CommanderCatMediator
	...
	[SCENE.BULLETINBOARD] = function (slot0, slot1)
		slot0.mediator = NewBulletinBoardMediator
	...
	[SCENE.MUSIC_FESTIVAL3] = function (slot0, slot1)
		slot0.mediator = MusicFestivalMediator
		slot0.viewComponent = MusicFestivalScene3
	end,
	...
	[SCENE.LIMIT_CHALLENGE] = function (slot0, slot1)
		slot0.mediator = LimitChallengeMediator
		slot0.viewComponent = LimitChallengeScene
	end,
	...
	[SCENE.IDOL_MEDAL_COLLECTION_SCENE3] = function (slot0, slot1)
		slot0.mediator = IdolMedalCollectionMediator
		slot0.viewComponent = IdolMedalCollectionView3
	end,
	...
	[SCENE.DOA2_MEDAL_COLLECTION_SCENE] = function (slot0, slot1)
		slot0.mediator = IdolMedalCollectionMediator
		slot0.viewComponent = Doa2MedalCollectionView
	end,
	[SCENE.GAME_HALL] = function (slot0, slot1)
		slot0.mediator = GameHallMediator
		slot0.viewComponent = GameHallScene
	end,
	[SCENE.ANNIVERSARY_ISLAND_BACKHILL_2023] = function (slot0, slot1)
		slot0.mediator = AnniversaryIsland2023Mediator
		slot0.viewComponent = AnniversaryIsland2023Scene
	end,
	[SCENE.ANNIVERSARY_ISLAND_WORKBENCH] = function (slot0, slot1)
		slot0.mediator = AnniversaryIslandComposite2023Mediator
		slot0.viewComponent = AnniversaryIslandComposite2023Scene
	end,
	[SCENE.ANNIVERSARY_ISLAND_SPRING] = function (slot0, slot1)
		slot0.mediator = AnniversaryIslandHotSpringMediator
		slot0.viewComponent = AnniversaryIslandHotSpringScene
	end,
	[SCENE.ANNIVERSARY_ISLAND_SPRING_TASK] = function (slot0, slot1)
		slot0.mediator = AnniversaryIslandSpringTask2023Mediator
		slot0.viewComponent = AnniversaryIslandSpringTask2023Scene
	end,
	[SCENE.ISLAND_TASK] = function (slot0, slot1)
		slot0.mediator = IslandTaskMediator
		slot0.viewComponent = IslandTaskScene
	end,
	[SCENE.ANNIVERSARY_ISLAND_SEA] = function (slot0, slot1)
		slot0.mediator = SixthAnniversaryIslandMediator
		slot0.viewComponent = SixthAnniversaryIslandScene
	end,
	[SCENE.SIXTH_ANNIVERSARY_JP] = function (slot0, slot1)
		slot0.mediator = BackHillMediatorTemplate
		slot0.viewComponent = SixthAnniversaryJPScene
	end,
	[SCENE.SIXTH_ANNIVERSARY_JP_DARK] = function (slot0, slot1)
		slot0.mediator = SixthAnniversaryJPDarkMediator
		slot0.viewComponent = SixthAnniversaryJPDarkScene
	end,
	[SCENE.SIXTH_ANNIVERSARY_JP_HOTSPRING] = function (slot0, slot1)
		slot0.mediator = SixthAnniversaryJPHotSpringMediator
		slot0.viewComponent = SixthAnniversaryJPHotSpringScene
	end,
	[SCENE.LAUNCH_BALL_TASK] = function (slot0, slot1)
		slot0.mediator = LaunchBallTaskMediator
		slot0.viewComponent = LaunchBallTaskScene
	end,
	...
	[SCENE.CASTLE_MAIN] = function (slot0, slot1)
		slot0.mediator = CastleMainMediator
		slot0.viewComponent = CastleMainScene
	end,
	...
	[SCENE.SENRANKAGURA_TRAIN] = function (slot0, slot1)
		slot0.mediator = SenrankaguraTrainMediator
		slot0.viewComponent = SenrankaguraTrainScene
	end,
	[SCENE.SENRANKAGURA_MEDAL] = function (slot0, slot1)
		slot0.mediator = SenrankaguraMedalMediator
		slot0.viewComponent = SenrankaguraMedalScene
	end,
	...
	[SCENE.OTHER_WORLD_TASK_LAYER] = function (slot0, slot1)
		slot0.mediator = OtherWorldTaskMediator
		slot0.viewComponent = OtherWorldTaskLayer
	end,
	[SCENE.OTHER_WORLD_TEMPLE_SCENE] = function (slot0, slot1)
		slot0.mediator = OtherWorldTempleMediator
		slot0.viewComponent = OtherWorldTempleScene
	end,
	[SCENE.OTHERWORLD_BACKHILL] = function (slot0, slot1)
		slot0.mediator = OtherworldBackHilllMediator
		slot0.viewComponent = OtherworldBackHillScene
	end,
...
slot1 = {
	...
	SculptureMediator = function (slot0, slot1)
		AnniversaryIsland2023Mediator.CheckPreloadData(slot0)
		slot1()
	end,
	AnniversaryIsland2023Mediator = function (slot0, slot1)
		...
		if slot0.context.data.fromMediatorName then
			return slot1()
		end
