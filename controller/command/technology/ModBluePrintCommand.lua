...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_9.level < var_1_10.need_lv then
		...
		if arg_2_0.result == 0 then
			...
			if var_1_4.level > var_2_0.level then
				for iter_2_0 = var_2_0.level + 1, var_1_4.level do
					...
					if var_2_2.special == 1 and type(var_2_2.special_effect) == "table" then
						local var_2_3 = var_2_2.special_effect

						for iter_2_1, iter_2_2 in ipairs(var_2_3) do
							local var_2_4 = iter_2_2[1]

							if var_2_4 == ShipBluePrint.STRENGTHEN_TYPE_SKILL then
							...
							elseif var_2_4 == ShipBluePrint.STRENGTHEN_TYPE_SKIN then
								...
								pg.TipsMgr.GetInstance():ShowTips(iter_2_2[3])
							elseif var_2_4 == ShipBluePrint.STRENGTHEN_TYPE_BREAKOUT then
			...
			elseif var_1_4.fateLevel > var_2_0.fateLevel then
				for iter_2_5 = var_2_0.fateLevel + 1, var_1_4.fateLevel do
					...
					if var_2_10.special == 1 and type(var_2_10.special_effect) == "table" then
						local var_2_11 = var_2_10.special_effect

						for iter_2_6, iter_2_7 in ipairs(var_2_11) do
							if iter_2_7[1] == ShipBluePrint.STRENGTHEN_TYPE_CHANGE_SKILL then
								...
								if var_2_18 and var_2_18.skillId == var_2_14 then
