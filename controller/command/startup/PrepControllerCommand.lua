...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	arg_1_0.facade:registerCommand(GAME.OPEN_MAIL, OpenMailCommand)
	arg_1_0.facade:registerCommand(GAME.DELETE_MAIL, DeleteMailCommand)
	arg_1_0.facade:registerCommand(GAME.DELETE_ALL_MAIL, DeleteAllMailCommand)
	arg_1_0.facade:registerCommand(GAME.TAKE_ATTACHMENT, TakeAttachmentCommand)
	arg_1_0.facade:registerCommand(GAME.TAKE_ALL_ATTACHMENT, TakeAllAttachmentCommand)
	arg_1_0.facade:registerCommand(GAME.CHANGE_MAIL_IMP_FLAG, ChangeMailImpFlagCommand)
