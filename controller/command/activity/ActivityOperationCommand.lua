...
function var_0_0.updateActivityData(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	elseif var_3_0 == ActivityConst.ACTIVITY_TYPE_BUILDSHIP_1 or var_3_0 == ActivityConst.ACTIVITY_TYPE_BUILDSHIP_PRAY or var_3_0 == ActivityConst.ACTIVITY_TYPE_NEWSERVER_BUILD then
		...
		if var_3_6.exchange_count > 0 then
			getProxy(buildShipProxy):changeRegularExchangeCount(arg_3_1.arg1 * var_3_6.exchange_count)
		end
	...
	elseif var_3_0 == ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF or var_3_0 == ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF_2 then
		if arg_3_1.cmd == 1 then
			...
			if var_3_35 < #var_3_34.buff then
				_.each(var_3_34.material[var_3_35], function(arg_4_0)
					local var_4_0 = arg_4_0[1]
					local var_4_1 = arg_4_0[2]
					local var_4_2 = arg_4_0[3]
					local var_4_3

					if var_4_0 == DROP_TYPE_VITEM then
						local var_4_4 = AcessWithinNull(Item.getConfigData(var_4_1), "link_id")

						assert(var_4_4 == arg_3_3.id)

						var_4_3 = arg_3_3
					elseif var_4_0 > DROP_TYPE_USE_ACTIVITY_DROP then
						local var_4_5 = AcessWithinNull(pg.activity_drop_type[var_4_0], "activity_id")

						var_4_3 = getProxy(ActivityProxy):getActivityById(var_4_5)
					end

					local var_4_6 = var_4_3.data1KeyValueList[1][var_4_1] or 0
					local var_4_7 = math.max(0, var_4_6 - var_4_2)

					var_4_3.data1KeyValueList[1][var_4_1] = var_4_7

					if var_4_0 > DROP_TYPE_USE_ACTIVITY_DROP then
						getProxy(ActivityProxy):updateActivity(var_4_3)
					end
				end)
			end
...
function var_0_0.performance(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	local var_5_0 = arg_5_3:getConfig("type")
	local var_5_1

	local function var_5_2()
		if var_5_1 and coroutine.status(var_5_1) == "suspended" then
			local var_6_0, var_6_1 = coroutine.resume(var_5_1)

			assert(var_6_0, var_6_1)
		end
	end

	var_5_1 = coroutine.create(function()
		if var_5_0 == ActivityConst.ACTIVITY_TYPE_7DAYSLOGIN then
			local var_7_0 = arg_5_3:getConfig("config_client").story

			if var_7_0 and var_7_0[arg_5_3.data1] and var_7_0[arg_5_3.data1][1] then
				pg.NewStoryMgr.GetInstance():Play(var_7_0[arg_5_3.data1][1], var_5_2)
				coroutine.yield()
			end
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_BB then
			local var_7_1 = pg.gameset.bobing_memory.description[arg_5_3.data1]

			if var_7_1 and #var_7_1 > 0 then
				pg.NewStoryMgr.GetInstance():Play(var_7_1, var_5_2)
				coroutine.yield()
			end

			arg_5_0:sendNotification(ActivityProxy.ACTIVITY_SHOW_BB_RESULT, {
				numbers = arg_5_2.number,
				callback = var_5_2,
				awards = arg_5_4
			})
			coroutine.yield()
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_LOTTERY_AWARD then
			if arg_5_1.cmd == 1 then
				local var_7_2 = arg_5_3:getConfig("config_client").story

				if var_7_2 and var_7_2[arg_5_3.data1] and var_7_2[arg_5_3.data1][1] then
					pg.NewStoryMgr.GetInstance():Play(var_7_2[arg_5_3.data1][1], var_5_2)
					coroutine.yield()
				end

				arg_5_0:sendNotification(ActivityProxy.ACTIVITY_SHOW_LOTTERY_AWARD_RESULT, {
					activityID = arg_5_3.id,
					awards = arg_5_4,
					number = arg_5_2.number[1],
					callback = var_5_2
				})
		...
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_CARD_PAIRS or var_5_0 == ActivityConst.ACTIVITY_TYPE_LINK_LINK then
			if arg_5_3:getConfig("config_client")[1] then
				local var_7_3 = arg_5_3:getConfig("config_client")[1][arg_5_3.data2 + 1]

				if var_7_3 then
					pg.NewStoryMgr.GetInstance():Play(var_7_3, var_5_2)
					coroutine.yield()
				end
			end
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_DODGEM or var_5_0 == ActivityConst.ACTIVITY_TYPE_SUBMARINE_RUN then
			if arg_5_1.cmd == 2 and arg_5_2.number[3] > 0 then
				local var_7_4 = arg_5_3:getConfig("config_client")[1]
				local var_7_5 = {
					type = var_7_4[1],
					id = var_7_4[2],
					count = var_7_4[3]
				...
				table.insert(arg_5_4, var_7_5)
			end
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF or var_5_0 == ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF_2 then
			if arg_5_1.cmd == 1 then
				pg.TipsMgr.GetInstance():ShowTips(i18n("building_complete_tip"))
			end
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_MONTHSIGN then
			if arg_5_1.cmd == 3 then
				local var_7_6 = arg_5_3:getSpecialData("month_sign_awards") or {}

				for iter_7_0 = 1, #arg_5_4 do
					table.insert(var_7_6, arg_5_4[iter_7_0])
				end

				arg_5_3:setSpecialData("month_sign_awards", var_7_6)

				arg_5_4 = {}
			end
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_SHAKE_BEADS then
			if arg_5_1.cmd == 1 then
				arg_5_0:sendNotification(ActivityProxy.ACTIVITY_SHOW_SHAKE_BEADS_RESULT, {
					number = arg_5_2.number[1],
					callback = var_5_2,
					awards = arg_5_4
				})
		...
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_APRIL_REWARD then
			if arg_5_1.cmd == 1 then
				arg_5_3.data1 = arg_5_1.arg1
			elseif arg_5_1.cmd == 2 then
				arg_5_3.data2 = 1
			end
		elseif var_5_0 == ActivityConst.ACTIVITY_TYPE_FIREWORK then
			pg.TipsMgr.GetInstance():ShowTips(i18n("activity_yanhua_tip8"))

			local var_7_7 = #arg_5_3:getData1List()
			local var_7_8 = arg_5_3:getConfig("config_client").story

			if var_7_8 and type(var_7_8) == "table" then
				for iter_7_1, iter_7_2 in ipairs(var_7_8) do
					if var_7_7 == iter_7_2[1] then
						pg.NewStoryMgr.GetInstance():Play(iter_7_2[2], var_5_2)
						coroutine.yield()
					end
				end
			end
		...
		if #arg_5_4 > 0 then
			arg_5_0:sendNotification(arg_5_3:getNotificationMsg(), {
				activityId = arg_5_1.activity_id,
				awards = arg_5_4,
				callback = var_5_2
			})
			coroutine.yield()
		...
		if var_5_0 == 17 and arg_5_1.cmd and arg_5_1.cmd == 2 then
			pg.TipsMgr.GetInstance():ShowTips(i18n("mingshi_get_tip"))
		end

		getProxy(ActivityProxy):updateActivity(arg_5_3)
		arg_5_0:sendNotification(ActivityProxy.ACTIVITY_OPERATION_DONE, arg_5_1.activity_id)
	end)
