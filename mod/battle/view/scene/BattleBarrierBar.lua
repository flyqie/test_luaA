...
function var_0_1.Shielding(arg_2_0, arg_2_1)
...
function var_0_1.Interrupt(arg_3_0)
...
function var_0_1.UpdateBarrierClockPosition(arg_5_0, arg_5_1)
	arg_5_0._barrierClockTF.position = arg_5_1 + var_0_1.OFFSET
end

function var_0_1.UpdateBarrierClockProgress(arg_6_0)
