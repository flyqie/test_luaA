...
var_0_0.Battle.DiveLeftState = class("DiveLeftState", var_0_0.Battle.IUnitState)
var_0_0.Battle.DiveLeftState.__name = "DiveLeftState"

local var_0_2 = var_0_0.Battle.DiveLeftState
