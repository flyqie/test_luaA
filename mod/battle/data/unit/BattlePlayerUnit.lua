...
function var_0_7.UpdateHP(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4)
	var_0_7.super.UpdateHP(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4)

	if arg_34_0._warningValue and arg_34_0._currentHP < arg_34_0._warningValue and not isHeal then
		arg_34_0._warningValue = nil

		local var_34_0 = arg_34_0:GetIntimacy()
		local var_34_1 = "hp_warning"
		local var_34_2 = var_0_1.GetWords(arg_34_0:GetSkinID(), var_34_1, var_34_0)

		arg_34_0:DispatchVoice(var_34_1)
		arg_34_0:DispatchChat(var_34_2, 2.5, var_34_1)
	end
