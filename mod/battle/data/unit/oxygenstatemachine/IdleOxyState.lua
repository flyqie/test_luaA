...
var_0_0.Battle.IdleOxyState = class("IdleOxyState", var_0_0.Battle.IOxyState)
var_0_0.Battle.IdleOxyState.__name = "IdleOxyState"

local var_0_3 = var_0_0.Battle.IdleOxyState
...
function var_0_3.UpdateDive(arg_9_0)
	return true
end
