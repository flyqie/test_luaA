...
function var_0_0.HandleDamage(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	arg_7_2:UpdateHP(var_7_5 * -1, var_7_14)
	arg_7_0:DamageStatistics(var_7_1.id, arg_7_2:GetAttrByName("id"), var_7_5)
	...
	if not var_7_8 and arg_7_1:GetWeaponTempData().type ~= var_0_3.EquipmentType.ANTI_AIR then
		...
		local var_7_15 = arg_7_1:GetHost()

		if var_7_15 and var_7_15:IsAlive() and var_7_15:GetUnitType() ~= ys.Battle.BattleConst.UnitType.AIRFIGHTER_UNIT then
			if table.contains(var_0_3.AircraftUnitType, var_7_15:GetUnitType()) then
				var_7_15 = var_7_15:GetMotherUnit()
			end

			local var_7_16 = var_7_15:GetIFF()

			for iter_7_0, iter_7_1 in pairs(arg_7_0._unitList) do
				if iter_7_1:GetIFF() == var_7_16 and iter_7_1 ~= var_7_15 then
	...
	local var_7_17 = arg_7_2:GetUnitType()
	local var_7_18 = true

	if var_7_17 ~= var_0_3.UnitType.AIRCRAFT_UNIT and var_7_17 ~= var_0_3.UnitType.AIRFIGHTER_UNIT and var_7_17 ~= var_0_3.UnitType.FUNNEL_UNIT and var_7_17 ~= var_0_3.UnitType.UAV_UNIT then
		var_7_18 = false
	end
	...
	if arg_7_2:IsAlive() then
		...
		arg_7_0:obituary(arg_7_2, var_7_18, arg_7_1)
...
function var_0_0.HandleDirectDamage(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	local var_9_1 = arg_9_1:GetAttrByName("id")

	arg_9_1:UpdateHP(arg_9_2 * -1, var_9_0)

	local var_9_2 = arg_9_1:IsAlive()

	if arg_9_3 then
		local var_9_3 = arg_9_3:GetAttrByName("id")

		arg_9_0:DamageStatistics(var_9_3, var_9_1, arg_9_2)

		if not var_9_2 then
			arg_9_0:KillCountStatistics(var_9_3, var_9_1)
		end
	end

	if not var_9_2 then
		local var_9_4 = arg_9_1:GetUnitType()
		local var_9_5 = true

		if var_9_4 ~= var_0_3.UnitType.AIRCRAFT_UNIT and var_9_4 ~= var_0_3.UnitType.AIRFIGHTER_UNIT and var_9_4 ~= var_0_3.UnitType.FUNNEL_UNIT and var_9_4 ~= var_0_3.UnitType.UAV_UNIT then
			var_9_5 = false
		end

		arg_9_0:obituary(arg_9_1, var_9_5, arg_9_3)
	end
end
...
function var_0_0.HandleWallDamage(arg_21_0, arg_21_1, arg_21_2)
	...
	arg_21_2:UpdateHP(var_21_1 * -1, var_21_7)
	arg_21_0:DamageStatistics(var_21_0, arg_21_2:GetAttrByName("id"), var_21_1)
