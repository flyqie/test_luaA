...
slot3.SetTemplate = function(slot0, slot1, slot2)
...
slot3.DisptachSkillFloat = function(slot0, slot1, slot2, slot3)
...
slot3.GetBuffLifeTime = function(slot0)
	return slot0._time
end

slot3.GetBuffStartTime = function(slot0)
