...
function var_0_3.SetTemplate(arg_2_0, arg_2_1, arg_2_2)
	arg_2_0._tempData = var_0_0.Battle.BattleDataFunction.GetBuffTemplate(arg_2_1, arg_2_2)
end

function var_0_3.Attach(arg_3_0, arg_3_1)
...
function var_0_3.Stack(arg_4_0, arg_4_1)
...
function var_0_3.SetOrb(arg_5_0, arg_5_1, arg_5_2)
	for iter_5_0, iter_5_1 in ipairs(arg_5_0._effectList) do
		iter_5_1:SetOrb(arg_5_0, arg_5_1, arg_5_2)
	end
end

function var_0_3.SetOrbDuration(arg_6_0, arg_6_1)
	arg_6_0._time = arg_6_1 + arg_6_0._time
end

function var_0_3.SetOrbLevel(arg_7_0, arg_7_1)
	arg_7_0._level = arg_7_1
end

function var_0_3.SetCommander(arg_8_0, arg_8_1)
...
function var_0_3.GetEffectList(arg_9_0)
	return arg_9_0._effectList
end

function var_0_3.GetCommander(arg_10_0)
	return arg_10_0._commander
end

function var_0_3.UpdateStack(arg_11_0, arg_11_1, arg_11_2)
	if arg_11_0._stack == arg_11_2 then
		return
	end
...
function var_0_3.Remove(arg_12_0, arg_12_1)
	...
	var_12_0:GetBuffList()[var_12_1] = nil
end

function var_0_3.Update(arg_13_0, arg_13_1, arg_13_2)
	if arg_13_0:IsTimeToRemove(arg_13_2) then
...
function var_0_3.SetArgs(arg_14_0, arg_14_1)
	for iter_14_0, iter_14_1 in ipairs(arg_14_0._effectList) do
		iter_14_1:SetCaster(arg_14_0._caster)
		iter_14_1:SetArgs(arg_14_1, arg_14_0)
	end
end

function var_0_3.Trigger(arg_15_0, arg_15_1, arg_15_2)
	...
	for iter_15_0, iter_15_1 in pairs(var_15_0) do
		...
		if var_15_2 ~= nil and #var_15_2 > 0 then
...
function var_0_3.DisptachSkillFloat(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	if arg_16_3.trigger == nil or table.contains(arg_16_3.trigger, arg_16_2) then
		local var_16_0

		if arg_16_3.painting and type(arg_16_3.painting) == "string" then
			var_16_0 = arg_16_3
		end

		local var_16_1 = getSkillName(arg_16_3.displayID or arg_16_0._id)

		arg_16_1:DispatchSkillFloat(var_16_1, nil, var_16_0)

		local var_16_2

		if arg_16_3.castCV ~= false then
...
function var_0_3.IsSubmarineSpecial(arg_17_0)
...
function var_0_3.onTrigger(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	for iter_18_0, iter_18_1 in ipairs(var_18_0) do
		...
		if iter_18_1:HaveQuota() and iter_18_1:IsActive() then
			iter_18_1:NotActive()
		...
		if arg_18_0._isCancel then
			break
		end
	end

	if arg_18_0._isCancel then
		arg_18_0._isCancel = nil

		arg_18_0:Remove()
	end
end

function var_0_3.SetRemoveTime(arg_19_0)
	...
	arg_19_0._cancelTime = nil
end

function var_0_3.IsTimeToRemove(arg_20_0, arg_20_1)
	if arg_20_0._isCancel then
		return true
	elseif arg_20_0._cancelTime and arg_20_1 >= arg_20_0._cancelTime then
		return true
	elseif arg_20_0._time == 0 then
		return false
	else
...
function var_0_3.GetBuffLifeTime(arg_21_0)
	return arg_21_0._time
end

function var_0_3.GetBuffStartTime(arg_22_0)
	return arg_22_0._buffStartTimeStamp
end

function var_0_3.Interrupt(arg_23_0)
	for iter_23_0, iter_23_1 in ipairs(arg_23_0._effectList) do
		iter_23_1:Interrupt()
	end
end

function var_0_3.Clear(arg_24_0)
	for iter_24_0, iter_24_1 in ipairs(arg_24_0._effectList) do
		iter_24_1:Clear()
	end
end

function var_0_3.GetID(arg_25_0)
	return arg_25_0._id
end

function var_0_3.GetCaster(arg_26_0)
	return arg_26_0._caster
end

function var_0_3.GetLv(arg_27_0)
	return arg_27_0._level or 1
end

function var_0_3.GetDuration(arg_28_0)
	return arg_28_0._time
end

function var_0_3.GetStack(arg_29_0)
	return arg_29_0._stack or 1
end

function var_0_3.SetToCancel(arg_30_0, arg_30_1)
	if arg_30_1 then
		if not arg_30_0._cancelTime then
...
function var_0_3.Dispose(arg_31_0)
	arg_31_0._triggerSearchTable = nil
	arg_31_0._commander = nil
end
