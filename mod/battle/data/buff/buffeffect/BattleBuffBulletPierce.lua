...
slot0.Battle.BattleBuffBulletPierce.Ctor = function(slot0, slot1)
	uv0.Battle.BattleBuffBulletPierce.super.Ctor(slot0, slot1)
end

slot0.Battle.BattleBuffBulletPierce.SetArgs = function(slot0, slot1, slot2)
...
slot0.Battle.BattleBuffBulletPierce.onBulletCreate = function(slot0, slot1, slot2, slot3)
	slot4 = slot3._bullet
