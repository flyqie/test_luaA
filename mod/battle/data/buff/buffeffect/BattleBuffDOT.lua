...
function var_0_4.SetArgs(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_0 = var_0_2.CaclulateDOTDuration(arg_3_0._tempData, arg_3_0._orb, arg_3_1)
...
function var_0_4.onUpdate(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	if arg_5_3.timeStamp >= arg_5_0._nextEffectTime then
		...
		var_0_0.Battle.BattleDataProxy.GetInstance():DamageStatistics(nil, arg_5_1:GetAttrByName("id"), var_5_0)
...
function var_0_4.onRemove(arg_6_0, arg_6_1, arg_6_2)
	...
	arg_6_1:UpdateHP(-var_6_0, var_6_1)
	var_0_0.Battle.BattleDataProxy.GetInstance():DamageStatistics(nil, arg_6_1:GetAttrByName("id"), var_6_0)
end

function var_0_4.CalcNumber(arg_7_0, arg_7_1, arg_7_2)
	local var_7_0 = var_0_2.CaclulateDOTDamageEnhanceRate(arg_7_0._tempData, arg_7_0._orb, arg_7_1)
	local var_7_1, var_7_2 = arg_7_1:GetHP()
	local var_7_3 = var_7_1 * arg_7_0._currentHPRatio + var_7_2 * arg_7_0._maxHPRatio + arg_7_0._number + arg_7_0._igniteDMG

	if arg_7_0._randExtraRange > 0 then
		var_7_3 = var_7_3 + math.random(0, arg_7_0._randExtraRange)
	end

	local var_7_4 = var_7_3 * (1 + var_7_0)

	return math.max(0, math.floor(math.min(var_7_1 - var_7_2 * arg_7_0._minRestHPRatio, var_7_4 * arg_7_2._stack * var_0_1.GetCurrent(arg_7_1, "repressReduce"))))
end
