...
function var_0_4.doBehaviour(arg_3_0)
	...
	if arg_3_0._targetIndex <= arg_3_0._rounds then
		...
		if var_3_2:GetAreaType() == var_0_1.AreaType.CUBE then
		...
		elseif var_3_2:GetAreaType() == var_0_1.AreaType.COLUMN then
...
function var_0_4.PlayAlert(arg_7_0, arg_7_1)
	...
	if var_7_5[var_7_1] and var_7_5[var_7_1].y_scale == true then
		var_7_4 = var_7_0
	end
