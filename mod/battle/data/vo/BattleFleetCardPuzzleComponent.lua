...
function var_0_12.PlayCard(arg_17_0, arg_17_1)
	if arg_17_0:CheckCardCastable(arg_17_1) then
		local function var_17_0()
			...
			if arg_17_1:GetMoveAfterCast() == var_0_12.CARD_PILE_INDEX_DISCARD then
...
function var_0_12.CheckCardCastable(arg_22_0, arg_22_1)
	...
	if var_22_0 <= arg_22_0._energy:GetCurrentEnergy() and var_22_1 then
		return true
	end
end
...
function var_0_12.onUpdateDeck(arg_60_0, arg_60_1)
	...
	if var_60_1.type == var_0_0.Battle.BattleFleetCardPuzzleCardManageComponent.FUNC_NAME_ADD or var_60_1.type == var_0_0.Battle.BattleFleetCardPuzzleCardManageComponent.FUNC_NAME_BOTTOM then
