...
function var_0_9.doAccelerate(arg_1_0, arg_1_1)
...
function var_0_9.doTrack(arg_2_0)
	...
	if var_2_5 >= var_0_9.TRACKER_ANGLE then
		return
	end
...
function var_0_9.doOrbit(arg_3_0)
...
function var_0_9.RotateY(arg_4_0, arg_4_1)
...
function var_0_9.doCircle(arg_5_0)
...
function var_0_9.ActiveCldBox(arg_9_0)
	arg_9_0._cldComponent:SetActive(true)
end

function var_0_9.DeactiveCldBox(arg_10_0)
	arg_10_0._cldComponent:SetActive(false)
end

function var_0_9.SetStartTimeStamp(arg_11_0, arg_11_1)
	arg_11_0._timeStamp = arg_11_1
end

function var_0_9.Hit(arg_12_0, arg_12_1, arg_12_2)
...
function var_0_9.Intercepted(arg_13_0)
	arg_13_0:DispatchEvent(var_0_0.Event.New(var_0_1.INTERCEPTED, {}))
end

function var_0_9.Reflected(arg_14_0)
	arg_14_0._speed.x = -arg_14_0._speed.x
end

function var_0_9.ResetVelocity(arg_15_0, arg_15_1)
...
function var_0_9.SetTemplateData(arg_16_0, arg_16_1)
...
function var_0_9.GetModleID(arg_18_0)
	local var_18_0 = arg_18_0:GetTemplate().extra_param
	local var_18_1

	if arg_18_0._IFF == var_0_5.FOE_CODE then
		if arg_18_0._mirrorSkin == var_0_9.MIRROR_SKIN_RES then
			var_18_1 = arg_18_0._modleID .. var_0_9.MIRROR_RES
		elseif arg_18_0._mirrorSkin == var_0_9.ORIGNAL_RES and var_18_0.mirror == true then
			var_18_1 = arg_18_0._modleID .. var_0_9.MIRROR_RES
		else
...
function var_0_9.SetModleID(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
...
function var_0_9.SetSFXID(arg_20_0, arg_20_1, arg_20_2)
	if arg_20_1 then
...
function var_0_9.SetShiftInfo(arg_21_0, arg_21_1, arg_21_2)
	local var_21_0 = 0
	local var_21_1 = 0
...
function var_0_9.SetRotateInfo(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
...
function var_0_9.SetBarrageTransformTempate(arg_23_0, arg_23_1)
	if #arg_23_1 > 0 then
		arg_23_0._barrageTransData = arg_23_1
	end
end

function var_0_9.SetAttr(arg_24_0, arg_24_1)
	var_0_0.Battle.BattleAttr.SetAttr(arg_24_0, arg_24_1)
end

function var_0_9.GetAttr(arg_25_0)
	return var_0_0.Battle.BattleAttr.GetAttr(arg_25_0)
end

function var_0_9.SetStandHostAttr(arg_26_0, arg_26_1)
	arg_26_0._standUnit = {}

	var_0_0.Battle.BattleAttr.SetAttr(arg_26_0._standUnit, arg_26_1)
end

function var_0_9.GetWeaponHostAttr(arg_27_0)
...
function var_0_9.GetWeaponAtkAttr(arg_28_0)
...
function var_0_9.GetWeaponCardPuzzleEnhance(arg_29_0)
	return arg_29_0._weapon:GetCardPuzzleDamageEnhance()
end

function var_0_9.SetDamageEnhance(arg_30_0, arg_30_1)
	arg_30_0._dmgEnhanceRate = arg_30_1
end

function var_0_9.GetDamageEnhance(arg_31_0)
	return arg_31_0._dmgEnhanceRate
end

function var_0_9.GetAttrByName(arg_32_0, arg_32_1)
	return var_0_0.Battle.BattleAttr.GetCurrent(arg_32_0, arg_32_1)
end

function var_0_9.GetVerticalSpeed(arg_33_0)
	return arg_33_0._verticalSpeed
end

function var_0_9.IsGravitate(arg_34_0)
	return arg_34_0._gravity ~= 0
end

function var_0_9.SetBuffTrigger(arg_35_0, arg_35_1)
	arg_35_0._host = arg_35_1
	arg_35_0._buffTriggerFun = {}
end

function var_0_9.SetBuffFun(arg_36_0, arg_36_1, arg_36_2)
...
function var_0_9.BuffTrigger(arg_37_0, arg_37_1, arg_37_2)
	local var_37_0 = arg_37_0._host

	if var_37_0 and var_37_0:IsAlive() then
...
function var_0_9.SetIsCld(arg_38_0, arg_38_1)
	arg_38_0._needCld = arg_38_1
end

function var_0_9.GetIsCld(arg_39_0)
	return arg_39_0._needCld
end

function var_0_9.IsIngoreCld(arg_40_0)
	return arg_40_0._tempData.extra_param.ingoreCld
end

function var_0_9.IsFragile(arg_41_0)
	return arg_41_0._tempData.extra_param.fragile
end

function var_0_9.IsIndiscriminate(arg_42_0)
	return arg_42_0._tempData.extra_param.indiscriminate
end

function var_0_9.GetExtraTag(arg_43_0)
	return arg_43_0._tempData.extra_param.tag
end

function var_0_9.AppendDamageUnit(arg_44_0, arg_44_1)
	arg_44_0._damageList[#arg_44_0._damageList + 1] = arg_44_1
end

function var_0_9.DamageUnitListWriteback(arg_45_0)
	arg_45_0._weapon:UpdateCombo(arg_45_0._damageList)
end

function var_0_9.HasAcceleration(arg_46_0)
	return #arg_46_0._accTable ~= 0
end

function var_0_9.IsTracker(arg_47_0)
	return arg_47_0._accTable.tracker
end

function var_0_9.IsOrbit(arg_48_0)
	return arg_48_0._accTable.orbit
end

function var_0_9.IsCircle(arg_49_0)
	return arg_49_0._accTable.circle
end

function var_0_9.GetAcceleration(arg_50_0, arg_50_1)
	...
	while var_50_2 > 0 do
		...
		if var_50_1 + var_0_9.ACC_INTERVAL < var_50_3.t then
			var_50_2 = var_50_2 - 1
		else
...
function var_0_9.reverseAcceleration(arg_51_0)
	for iter_51_0, iter_51_1 in ipairs(arg_51_0._accTable) do
		iter_51_1.u = iter_51_1.u * -1
	end
end

function var_0_9.GetDistance(arg_52_0, arg_52_1)
...
function var_0_9.backupDistance(arg_53_0, arg_53_1, arg_53_2)
...
function var_0_9.getTrackingTarget(arg_54_0)
	return arg_54_0._tarckingTarget
end

function var_0_9.setTrackingTarget(arg_55_0, arg_55_1)
	arg_55_0._tarckingTarget = arg_55_1
end

function var_0_9.SetWeapon(arg_56_0, arg_56_1)
...
function var_0_9.GetWeapon(arg_57_0)
	return arg_57_0._weapon
end

function var_0_9.GetCorrectedDMG(arg_58_0)
	return arg_58_0._correctedDMG
end

function var_0_9.OverrideCorrectedDMG(arg_59_0, arg_59_1)
	arg_59_0._correctedDMG = var_0_2.WeaponDamagePreCorrection(arg_59_0._weapon, arg_59_1)
end

function var_0_9.GetWeaponTempData(arg_60_0)
	return arg_60_0._weapon:GetTemplateData()
end

function var_0_9.GetPosition(arg_61_0)
	return arg_61_0._position or Vector3.zero
end

function var_0_9.SetSpawnPosition(arg_62_0, arg_62_1)
...
function var_0_9.GetSpawnPosition(arg_63_0)
	return arg_63_0._spawnPos
end

function var_0_9.GetTemplate(arg_64_0)
	return arg_64_0._tempData
end

function var_0_9.GetType(arg_65_0)
	return arg_65_0._tempData.type
end

function var_0_9.GetHitSFX(arg_66_0)
	return arg_66_0._hitSFX
end

function var_0_9.GetMissSFX(arg_67_0)
	return arg_67_0._missSFX
end

function var_0_9.GetOutBound(arg_68_0)
	return arg_68_0._tempData.out_bound
end

function var_0_9.GetUniqueID(arg_69_0)
	return arg_69_0._uniqueID
end

function var_0_9.GetOffset(arg_70_0)
	return arg_70_0._offsetX, arg_70_0._offsetZ, arg_70_0._isOffsetPriority
end

function var_0_9.GetRotateInfo(arg_71_0)
	return arg_71_0._targetPos, arg_71_0._baseAngle, arg_71_0._barrageAngle
end

function var_0_9.IsOutRange(arg_72_0)
	return arg_72_0._reachDestFlag
end

function var_0_9.SetYAngle(arg_73_0, arg_73_1)
	arg_73_0._yAngle = arg_73_1
end

function var_0_9.SetOffsetPriority(arg_74_0, arg_74_1)
	arg_74_0._isOffsetPriority = arg_74_1 or false
end

function var_0_9.GetOffsetPriority(arg_75_0)
	return arg_75_0._isOffsetPriority
end

function var_0_9.GetYAngle(arg_76_0)
	return arg_76_0._yAngle
end

function var_0_9.GetCurrentYAngle(arg_77_0)
...
function var_0_9.GetIFF(arg_78_0)
	return arg_78_0._IFF
end

function var_0_9.GetHost(arg_79_0)
	return arg_79_0._host
end

function var_0_9.GetPierceCount(arg_80_0)
	return arg_80_0._pierceCount
end

function var_0_9.AppendAttachBuff(arg_81_0, arg_81_1)
...
function var_0_9.GetEffectField(arg_84_0)
	return arg_84_0._field
end

function var_0_9.SetDiverFilter(arg_85_0, arg_85_1)
...
function var_0_9.GetDiveFilter(arg_86_0)
	return arg_86_0._diveFilter
end

function var_0_9.GetVelocity(arg_87_0)
	return arg_87_0._velocity
end

function var_0_9.GetConvertedVelocity(arg_88_0)
	return arg_88_0._convertedVelocity
end

function var_0_9.GetSpeedExemptKey(arg_89_0)
	return arg_89_0._speedExemptKey
end

function var_0_9.IsCollided(arg_90_0, arg_90_1)
	return arg_90_0._collidedList[arg_90_1]
end

function var_0_9.GetExist(arg_91_0)
	return arg_91_0._exist
end

function var_0_9.SetExist(arg_92_0, arg_92_1)
	arg_92_0._exist = arg_92_1
end

function var_0_9.GetIgnoreShield(arg_93_0)
	return arg_93_0._ignoreShield
end

function var_0_9.SetIgnoreShield(arg_94_0, arg_94_1)
	arg_94_0._ignoreShield = arg_94_1
end

function var_0_9.IsAutoRotate(arg_95_0)
	return arg_95_0._autoRotate
end

function var_0_9.Dispose(arg_96_0)
	arg_96_0._dataProxy = nil

	var_0_0.EventDispatcher.DetachEventDispatcher(arg_96_0)
end

function var_0_9.InitCldComponent(arg_97_0)
...
function var_0_9.ResetCldSurface(arg_98_0)
...
function var_0_9.GetBoxSize(arg_99_0)
	return arg_99_0._cldComponent:GetCldBoxSize()
end

function var_0_9.GetCldBox(arg_100_0)
	return arg_100_0._cldComponent:GetCldBox(arg_100_0:GetPosition())
end

function var_0_9.GetCldData(arg_101_0)
...
function var_0_9.GetSpeedRatio(arg_103_0)
	return var_0_4.GetSpeedRatio(arg_103_0._speedExemptKey, arg_103_0._IFF)
end

function var_0_9.InitSpeed(arg_104_0, arg_104_1)
...
function var_0_9.calcSpeed(arg_105_0)
...
function var_0_9.updateBarrageTransform(arg_106_0, arg_106_1)
	if not arg_106_0._barrageTransData or #arg_106_0._barrageTransData == 0 then
		return
	end
	...
	if var_106_0 >= var_106_1.transStartDelay then
		if var_106_1.transAimAngle then
...
function var_0_9.GetCurrentDistance(arg_107_0)
	return Vector3.Distance(arg_107_0._spawnPos, arg_107_0._position)
end

function var_0_9.SetOutRangeCallback(arg_108_0, arg_108_1)
	arg_108_0._outRangeFunc = arg_108_1
end

function var_0_9.OutRange(arg_109_0)
	arg_109_0:DispatchEvent(var_0_0.Event.New(var_0_1.OUT_RANGE, {}))
	arg_109_0._outRangeFunc(arg_109_0)
end

function var_0_9.FixRange(arg_110_0, arg_110_1, arg_110_2)
...
function var_0_9.ImmuneBombCLS(arg_111_0)
	return arg_111_0:GetTemplate().extra_param.ignoreB
end

function var_0_9.ImmuneCLS(arg_112_0)
	return arg_112_0._immuneCLS
end

function var_0_9.SetImmuneCLS(arg_113_0, arg_113_1)
