...
slot3 = class("BattleWorldBossCommand", slot0.Battle.BattleSingleDungeonCommand)
slot0.Battle.BattleWorldBossCommand = slot3
slot3.__name = "BattleWorldBossCommand"
...
slot3.onInitBattle = function(slot0)
	...
	slot0._specificEnemyList = uv1.Battle.BattleDataFunction.GetSpecificWorldJointEnemyList(slot1.ActID, slot1.bossConfigId, slot1.bossLevel)
end
...
slot3.calcDamageData = function(slot0)
	...
	slot0._dataProxy:CalcWorldBossDamageInfo(slot1.ActID, slot1.bossConfigId, slot1.bossLevel)
end
