...
function var_0_0.Battle.BattleControllerCommand.Ctor(arg_1_0)
	var_0_0.Battle.BattleControllerCommand.super.Ctor(arg_1_0)
end

function var_0_0.Battle.BattleControllerCommand.Initialize(arg_2_0)
...
function var_0_0.Battle.BattleControllerCommand.InitBattleEvent(arg_3_0)
	return
end

function var_0_0.Battle.BattleControllerCommand.addSpeed(arg_4_0)
...
function var_0_0.Battle.BattleControllerCommand.removeSpeed(arg_5_0)
...
function var_0_0.Battle.BattleControllerCommand.scaleTime(arg_6_0)
