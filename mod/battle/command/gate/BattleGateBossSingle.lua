slot0 = class("BattleGateBossSingle")
ys.Battle.BattleGateBossSingle = slot0
slot0.__name = "BattleGateBossSingle"
...
slot0.Entrance = function(slot0, slot1)
	...
	slot7 = pg.battle_cost_template[SYSTEM_BOSS_SINGLE].oil_cost > 0
	...
	BeginStageCommand.SendRequest(SYSTEM_BOSS_SINGLE, slot12, {
		slot9
	}, function (slot0)
		if uv0 then
			uv1:consume({
...
slot0.Exit = function(slot0, slot1)
	...
	slot14 = {}
	slot15 = {}
	slot16 = pg.battle_cost_template[SYSTEM_BOSS_SINGLE].oil_cost > 0
	...
	slot1:SendRequest(slot18, function (slot0)
		...
		uv0.GeneralPlayerCosume(SYSTEM_BOSS_SINGLE, slot3, uv5, slot0.player_exp)

		if slot3 then
			slot5 = getProxy(ActivityProxy):getActivityById(uv1.actId)
			slot6 = slot5:GetEnemyDataByStageId(uv1.stageId)

			slot5:AddDailyCount(slot6.id)
			slot5:AddPassStage(slot6:GetExpeditionId())
