...
function var_0_0.flush(arg_3_0)
	...
	setScrollText(arg_3_0.nameTxt, var_3_0:GetColorName())
	arg_3_0:updateProps({})
	setPaintingPrefabAsync(arg_3_0.paintingTr, var_3_0:getPainting(), "biandui")

	local var_3_3 = var_3_0:rarity2bgPrint()
	...
	setProposeMarkIcon(arg_3_0.proposeMark, var_3_0)

	local var_3_6 = arg_3_0.shipVO:getShipType()

	setImageSprite(arg_3_0.shipType, GetSpriteFromAtlas("shiptype", shipType2print(var_3_6)))
end
...
function var_0_0.clear(arg_6_0)
	...
	if var_6_0 then
		retPaintingPrefab(arg_6_0.paintingTr, var_6_0:getPainting())
	end
