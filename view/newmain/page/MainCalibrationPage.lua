local var_0_0 = class("MainCalibrationPage", import("...base.BaseSubView"))
...
function var_0_0.OnLoaded(arg_2_0)
	...
	arg_2_0.bgImage = arg_2_0._tf:GetComponent(typeof(Image))
...
function var_0_0.ResetPostion(arg_16_0)
	...
	arg_16_0.paintingTF.anchoredPosition = Vector2(MainPaintingView.PAINT_DEFAULT_POS_X, MainPaintingView.DEFAULT_HEIGHT)
	arg_16_0.paintingTF.localScale = Vector3.one
end

function var_0_0.ShowOrHide(arg_17_0, arg_17_1, arg_17_2)
	if arg_17_1 then
		arg_17_0:Show()
	else
		arg_17_0:Hide()
...
function var_0_0.Show(arg_18_0)
	...
	arg_18_0:DoBottomAnimation(0, 100)
	arg_18_0:DoLeftAnimation(0, -150, function()
		return
	end)
	setParent(arg_18_0._tf, pg.UIMgr.GetInstance().OverlayMain)
end

function var_0_0.DoLeftAnimation(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	LeanTween.value(arg_20_0.backBtn.gameObject, arg_20_1, arg_20_2, 0.3):setOnUpdate(System.Action_float(function(arg_21_0)
		arg_20_0.backBtn.anchoredPosition = Vector2(arg_21_0, arg_20_0.backBtn.anchoredPosition.y)
	end)):setOnComplete(System.Action(arg_20_3))
end

function var_0_0.DoBottomAnimation(arg_22_0, arg_22_1, arg_22_2)
	LeanTween.value(arg_22_0.moveBtn.gameObject, arg_22_1, arg_22_2, 0.3):setOnUpdate(System.Action_float(function(arg_23_0)
		arg_22_0.moveBtn.anchoredPosition = Vector2(arg_22_0.moveBtn.anchoredPosition.x, arg_23_0)
		arg_22_0.setBtn.anchoredPosition = Vector2(arg_22_0.setBtn.anchoredPosition.x, arg_23_0)
	end))
	setParent(arg_22_0._tf, pg.UIMgr.GetInstance().UIMain)
end

function var_0_0.Hide(arg_24_0)
	arg_24_0:DoBottomAnimation(100, 0)
	arg_24_0:DoLeftAnimation(-150, 0, function()
