local var_0_0 = class("CastleGameJoyStick")
...
function var_0_0.step(arg_8_0)
	...
	arg_8_0.angle = math.atan(math.abs(arg_8_0.currentY - arg_8_0.startPos.y) / math.abs(arg_8_0.currentX - arg_8_0.startPos.x))
