...
function var_0_0.preload(arg_124_0, arg_124_1)
	...
	ResourceMgr.Inst:loadAssetBundleAsync("ui/blackwhitegrid_atlas", function(arg_125_0)
		for iter_125_0 = 0, 4 do
			var_0_17[iter_125_0] = {}

			for iter_125_1 = 0, 2 do
				local var_125_0 = ResourceMgr.Inst:LoadAssetSync(arg_125_0, iter_125_0 .. "_" .. iter_125_1, nil, true, false)
