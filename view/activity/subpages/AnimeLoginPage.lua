local var_0_0 = class("AnimeLoginPage", import(".TemplatePage.LoginTemplatePage"))
...
function var_0_0.updateAwardInfo(arg_11_0, arg_11_1)
	setImageSprite(arg_11_0.dayProgressImg, GetSpriteFromAtlas("ui/activityuipage/animelogin_atlas", "tianshu_" .. arg_11_1), true)
	setImageSprite(arg_11_0.awardImg, GetSpriteFromAtlas("ui/activityuipage/animelogin_atlas", "icon_" .. arg_11_1), true)
