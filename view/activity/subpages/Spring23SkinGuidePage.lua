local var_0_0 = class("Spring23SkinGuidePage", import("...base.BaseActivityPage"))
...
function var_0_0.OnUpdateFlush(arg_7_0)
	...
	setImageSprite(arg_7_0.countImg, GetSpriteFromAtlas(var_0_1, tostring(arg_7_0.remainCnt)), true)
