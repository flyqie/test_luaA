...
function var_0_0.OnDataSetting(arg_2_0)
	...
	if type(var_2_0) == "table" and var_2_0[2] and type(var_2_0[2]) == "string" and not pg.NewStoryMgr.GetInstance():IsPlayed(var_2_0[2]) then
	...
	if arg_2_0.activity.data1 == 0 then
		...
		if arg_2_0.activity:getConfig("config_client").autounlock <= var_2_2 - var_2_1 then
			arg_2_0:emit(ActivityMediator.EVENT_OPERATION, {
				arg1 = 1,
				cmd = 1,
				activity_id = arg_2_0.activity.id
