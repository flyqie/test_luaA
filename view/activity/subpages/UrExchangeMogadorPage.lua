slot0 = class("UrExchangeMogadorPage", import("...base.BaseActivityPage"))
slot0.SP_FIRST = 1
slot0.SP_DAILY = 2
...
slot0.taskTypeDic = {
	...
	[slot0.RANDOM_DAILY] = function (slot0, slot1)
		...
		uv1(slot4, slot5, slot6)

		return slot5 .. "/" .. slot6, slot4 ~= 0 and slot3 or nil
	end,
...
slot0.UpdateTask = function(slot0, slot1, slot2)
	...
	setText(slot0:findTF("name", slot2), slot0.taskConfig[slot3][2])
...
slot0.OnUpdateFlush = function(slot0)
	...
	setGray(slot0._btnExchange, slot0.exchangeState == 3, false)

	slot0._btnExchange:GetComponent("Image").raycastTarget = slot0.exchangeState ~= 3
end
