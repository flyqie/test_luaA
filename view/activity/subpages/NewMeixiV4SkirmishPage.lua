...
function var_0_0.SetClearNum(arg_4_0)
	...
	for iter_4_0, iter_4_1 in ipairs(arg_4_0.taskList) do
		if arg_4_0.taskProxy:getTaskById(iter_4_1) or arg_4_0.taskProxy:getFinishTaskById(iter_4_1) then
...
function var_0_0.IsShowRed()
	...
	local function var_10_3()
		for iter_11_0, iter_11_1 in ipairs(var_10_2) do
	...
	for iter_10_4, iter_10_5 in ipairs(var_10_2) do
		...
		if var_10_5 and var_10_5:getTaskStatus() == 2 then
			var_10_4 = var_10_4 + 1

			if not var_10_6 or not var_10_7 then
				var_10_4 = var_10_4 - 1
			end
		end
	end
