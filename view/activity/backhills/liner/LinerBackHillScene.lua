...
slot0.didEnter = function(slot0)
	...
	slot1 = slot1:getActivityById(uv0.TASK_ACT_ID)
	slot3 = pg.NewStoryMgr.GetInstance()
	slot3 = not slot3:IsPlayed(slot1:getConfig("config_client").preStory)
	...
	if PLATFORM_CODE == PLATFORM_CH then
		setActive(slot0.day_btn_cruise, false)
		setActive(slot0.night_btn_cruise, false)
	else
