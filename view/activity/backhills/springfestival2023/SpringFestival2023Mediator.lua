slot0 = class("SpringFestival2023Mediator", import("..TemplateMV.BackHillMediatorTemplate"))
slot0.MINI_GAME_OPERATOR = "MINI_GAME_OPERATOR"
slot0.GO_SCENE = "GO_SCENE"
slot0.GO_SUBLAYER = "GO_SUBLAYER"
slot0.PLAY_FIREWORKS = "PLAY_FIREWORKS"
...
slot0.handleNotification = function(slot0, slot1)
	...
	elseif slot2 == uv0.PLAY_FIREWORKS then
		slot0.viewComponent:PlayFireworks(slot3)
	end
end
