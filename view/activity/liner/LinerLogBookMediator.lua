...
slot0.register = function(slot0)
	slot0:bind(uv0.GET_SCHEDULE_AWARD, function (slot0, slot1, slot2)
	...
	slot0:bind(uv0.GET_ROOM_AWARD, function (slot0, slot1, slot2)
		uv0:sendNotification(GAME.ACTIVITY_LINER_OP, {
			cmd = 3,
			activity_id = slot1,
			arg1 = slot2
	...
	slot0:bind(uv0.GET_EVENT_AWARD, function (slot0, slot1, slot2, slot3)
		uv0:sendNotification(GAME.ACTIVITY_LINER_OP, {
			cmd = 4,
			activity_id = slot1,
			arg1 = slot2,
