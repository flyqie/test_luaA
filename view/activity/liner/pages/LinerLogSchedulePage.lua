...
slot0.OnInit = function(slot0)
	...
	onButton(slot0, slot0.getBtn, function ()
		uv0:emit(LinerLogBookMediator.GET_SCHEDULE_AWARD, uv0.activity.id, uv0.curIdx)
	end, SFX_CONFIRM)
...
slot0._getLogDesc = function(slot0, slot1)
	...
	return string.format("%d:00 %s~%d:59 %s", slot2 <= 12 and slot2 or slot2 - 12, slot2 <= 12 and "AM" or "PM", slot3 < 12 and slot3 or slot3 - 12, slot3 < 12 and "AM" or "PM")
end
