...
function var_0_0.updateModPanel(arg_93_0)
	...
	pressPersistTrigger(arg_93_0.calcMinusBtn, 0.5, function(arg_101_0)
	...
	pressPersistTrigger(arg_93_0.calcPlusBtn, 0.5, function(arg_102_0)
...
function var_0_0.updateFittingPanel(arg_109_0)
	...
	pressPersistTrigger(arg_109_0.fittingCalcMinusBtn, 0.5, function(arg_119_0)
	...
	pressPersistTrigger(arg_109_0.fittingCalcPlusBtn, 0.5, function(arg_120_0)
...
function var_0_0.updateAdvanceTF(arg_127_0, arg_127_1, arg_127_2, arg_127_3)
	...
	for iter_127_0 = 1, #var_127_1 do
		...
		if var_127_1[iter_127_0] then
			if var_127_1[iter_127_0][1] == ShipBluePrint.STRENGTHEN_TYPE_BREAKOUT then
				...
				setText(var_127_7:Find("Text"), var_127_1[iter_127_0][3])
			end
		end
	end
	...
	for iter_127_1 = 1, #var_127_2 do
		...
		setText(var_127_10:Find("Text"), var_127_2[iter_127_1])
	end
end
