...
function var_0_0.init(arg_2_0)
	...
	eachChild(arg_2_0.rtGiftPanel:Find("content/toggles"), function(arg_4_0)
		onToggle(arg_2_0, arg_4_0, function(arg_5_0)
			if arg_5_0 then
				arg_2_0:UpdateSelectToggle(arg_4_0.name)
			end
		end, SFX_PANEL)
	end)
...
function var_0_0.UpdateGift(arg_19_0, arg_19_1, arg_19_2)
	...
	onButton(arg_19_0, var_19_0:Find("info/btn_info"), function()
		arg_19_0:OpenInfoWindow(var_19_1)
	end, SFX_PANEL)
...
function var_0_0.SingleUpdateGift(arg_23_0, arg_23_1)
...
function var_0_0.UpdateConfirmBtn(arg_24_0)
	setButtonEnabled(arg_24_0.btnConfirm, tobool(arg_24_0.selectGiftId))
end

function var_0_0.ConfirmGiveGifts(arg_25_0)
	if arg_25_0.proxy:getGiftCount(arg_25_0.selectGiftId) == 0 then
		if pg.dorm3d_gift[arg_25_0.selectGiftId].ship_group_id > 0 and arg_25_0.proxy:isGiveGiftDone(arg_25_0.selectGiftId) then
...
function var_0_0.AfterGiveGift(arg_26_0, arg_26_1)
	local var_26_0 = pg.dorm3d_gift[arg_26_1]
	local var_26_1 = {}

	if var_26_0.reply_dialogue_id ~= 0 then
...
function var_0_0.UpdateFavorPanel(arg_30_0)
...
function var_0_0.OpenInfoWindow(arg_31_0, arg_31_1)
...
function var_0_0.OpenLackWindow(arg_34_0, arg_34_1)
	...
	UIItemList.StaticAlign(var_34_4, var_34_4:Find("tpl"), #var_34_3, function(arg_35_0, arg_35_1, arg_35_2)
		...
		if arg_35_0 == UIItemList.EventUpdate then
			...
			if var_35_6 and var_35_6 ~= 0 then
...
function var_0_0.HideLackWindow(arg_38_0)
...
function var_0_0.onBackPressed(arg_39_0)
	if isActive(arg_39_0.rtInfoWindow) then
		arg_39_0:HideInfoWindow()

		return
	end

	if isActive(arg_39_0.rtLackWindow) then
...
function var_0_0.willExit(arg_40_0)
	if isActive(arg_40_0.rtInfoWindow) then
		arg_40_0:HideInfoWindow()
	end

	if isActive(arg_40_0.rtLackWindow) then
