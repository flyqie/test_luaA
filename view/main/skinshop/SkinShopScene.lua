...
function var_0_0.initSkinPage(arg_31_0)
	...
	for iter_31_2, iter_31_3 in ipairs(arg_31_0.skinGoodsVOs) do
		...
		local var_31_2 = var_0_2[var_31_1].shop_type_id
		local var_31_3 = var_31_2 == 0 and 9999 or var_31_2

		arg_31_0.countByIds[var_31_3] = arg_31_0.countByIds[var_31_3] + 1
	end

	local var_31_4 = arg_31_0:findTF("toggles/mask/content", arg_31_0.leftPanel)
	local var_31_5 = {}

	for iter_31_4, iter_31_5 in ipairs(var_31_0) do
		if arg_31_0.countByIds[iter_31_5] > 0 then
			table.insert(var_31_5, iter_31_5)
		end
	end

	if arg_31_0.existAnyEncoreSkin then
		table.insert(var_31_5, var_0_0.PAGE_ENCORE)
	end

	assert(not table.contains(var_31_5, var_0_0.PAGE_ALL) and not table.contains(var_31_5, var_0_0.PAGE_TIME_LIMIT))

	if arg_31_0.viewMode == var_0_0.SHOP_TYPE_TIMELIMIT then
		table.insert(var_31_5, 1, var_0_0.PAGE_TIME_LIMIT)
	end

	table.insert(var_31_5, 1, var_0_0.PAGE_ALL)

	arg_31_0.pageTFs, arg_31_0.mid = {}, 4

	local var_31_6 = var_31_4.parent:Find("0")

	arg_31_0.skinPageToggles = {}

	for iter_31_6, iter_31_7 in ipairs(var_31_5) do
		local var_31_7 = cloneTplTo(var_31_6, var_31_4, iter_31_7)

		setActive(var_31_7, true)

		arg_31_0.skinPageToggles[iter_31_7] = var_31_7:Find("toggle")
		...
		arg_31_0:UpdateTagStyle(var_31_7, var_0_1, iter_31_7)
	end

	eachChild(var_31_4, function(arg_33_0)
	...
	arg_31_0:UpdateViewMode(var_31_4)
end
...
function var_0_0.updateMainView(arg_41_0, arg_41_1)
	...
	local var_41_4 = PathMgr.FileExists(PathMgr.getAssetBundle("painting/" .. var_41_3 .. "_n"))
...
function var_0_0.UpdateLiveToggle(arg_43_0, arg_43_1, arg_43_2)
	...
	local var_43_7 = PathMgr.FileExists(PathMgr.getAssetBundle("painting/" .. var_43_6 .. "_n"))
	local var_43_8 = true
...
function var_0_0.UpdateSpineState(arg_45_0, arg_45_1, arg_45_2)
	...
	local var_45_3 = PathMgr.FileExists(PathMgr.getAssetBundle(var_45_2))
...
function var_0_0.UpdateLive2dDownloadState(arg_50_0, arg_50_1, arg_50_2)
	...
	local var_50_3 = PathMgr.FileExists(PathMgr.getAssetBundle(var_50_2))
...
function var_0_0.setPaintingPrefab(arg_82_0, arg_82_1, arg_82_2, arg_82_3, arg_82_4)
	...
	if not arg_82_4 and PathMgr.FileExists(PathMgr.getAssetBundle("painting/" .. arg_82_2 .. "_n")) then
		arg_82_2 = arg_82_2 .. "_n"
	end

	if PathMgr.FileExists(PathMgr.getAssetBundle("painting/" .. arg_82_2)) then
		pg.UIMgr.GetInstance():LoadingOn()
