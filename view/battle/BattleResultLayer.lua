...
function var_0_0.didEnter(arg_12_0)
	...
	if arg_12_0.contextData.system ~= SYSTEM_BOSS_RUSH and arg_12_0.contextData.system ~= SYSTEM_BOSS_RUSH_EX and arg_12_0.contextData.system ~= SYSTEM_ACT_BOSS then
...
function var_0_0.showRewardInfo(arg_23_0)
	...
	var_23_0 = coroutine.create(function()
		...
		if table.getCount(var_25_10) > 0 then
			...
			elseif arg_23_0.contextData.system == SYSTEM_ACT_BOSS and getProxy(ContextProxy):getCurrentContext():getContextByMediator(ContinuousOperationMediator) then
