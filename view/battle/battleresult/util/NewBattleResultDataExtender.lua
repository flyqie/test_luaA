...
function var_0_0.NeedCloseCamera(arg_1_0)
	return arg_1_0 ~= SYSTEM_BOSS_RUSH and arg_1_0 ~= SYSTEM_BOSS_RUSH_EX and arg_1_0 ~= SYSTEM_ACT_BOSS and arg_1_0 ~= SYSTEM_WORLD_BOSS
end
...
function var_0_0.GetExpBuffs(arg_5_0)
	...
	if arg_5_0 == SYSTEM_SCENARIO or arg_5_0 == SYSTEM_ROUTINE or arg_5_0 == SYSTEM_ACT_BOSS or arg_5_0 == SYSTEM_HP_SHARE_ACT_BOSS or arg_5_0 == SYSTEM_SUB_ROUTINE or arg_5_0 == SYSTEM_WORLD then
...
function var_0_0.GetShipBuffs(arg_7_0)
	...
	if arg_7_0 == SYSTEM_SCENARIO or arg_7_0 == SYSTEM_ROUTINE or arg_7_0 == SYSTEM_ACT_BOSS or arg_7_0 == SYSTEM_HP_SHARE_ACT_BOSS or arg_7_0 == SYSTEM_SUB_ROUTINE or arg_7_0 == SYSTEM_WORLD then
...
function var_0_0.GetNewMainShips(arg_17_0)
	...
	elseif var_17_0 == SYSTEM_HP_SHARE_ACT_BOSS or var_17_0 == SYSTEM_ACT_BOSS or var_17_0 == SYSTEM_ACT_BOSS_SP or var_17_0 == SYSTEM_BOSS_EXPERIMENT then
