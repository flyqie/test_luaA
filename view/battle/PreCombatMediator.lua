...
function var_0_0.register(arg_1_0)
	...
	elseif var_1_0 == SYSTEM_SUB_ROUTINE then
...
function var_0_0.bindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_0.CHANGE_FLEET_SHIP, function(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
		...
		local var_10_2 = var_10_0 and ShipStatus.TAG_BLOCK_PVP or nil
	...
	arg_2_0:bind(var_0_0.ON_START, function(arg_12_0, arg_12_1, arg_12_2)
		seriesAsync({
			function(arg_13_0)
				...
				for iter_13_0, iter_13_1 in ipairs(var_13_2.ships) do
...
function var_0_0.commitEdit(arg_22_0, arg_22_1)
	...
	if var_22_1 == nil or var_22_1:isFirstFleet() or var_22_1:isLegalToFight() == true then
		var_22_0:commitEdittingFleet(arg_22_1)
	elseif #var_22_1.ships == 0 then
		var_22_0:commitEdittingFleet(arg_22_1)
