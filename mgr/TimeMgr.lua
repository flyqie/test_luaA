...
function var_0_1.CTimeDescC(arg_24_0, arg_24_1, arg_24_2)
	arg_24_2 = arg_24_2 or "%Y%m%d%H%M%S"

	return os.date(arg_24_2, arg_24_1)
end

function var_0_1.STimeDescC(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
...
function var_0_1.STimeDescS(arg_26_0, arg_26_1, arg_26_2)
...
function var_0_1.CurrentSTimeDesc(arg_27_0, arg_27_1, arg_27_2)
	if arg_27_2 then
...
function var_0_1.ChieseDescTime(arg_28_0, arg_28_1, arg_28_2)
...
function var_0_1.GetTimeToNextTime(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
...
function var_0_1.GetNextTime(arg_30_0, arg_30_1, arg_30_2, arg_30_3, arg_30_4)
	return arg_30_0:GetTimeToNextTime(nil, arg_30_4, arg_30_1 * var_0_2 + arg_30_2 * 60 + arg_30_3)
end

function var_0_1.GetNextTimeByTimeStamp(arg_31_0, arg_31_1)
	return arg_31_0:GetTimeToNextTime(arg_31_1) - var_0_3
end

function var_0_1.GetNextWeekTime(arg_32_0, arg_32_1, arg_32_2, arg_32_3, arg_32_4)
	return arg_32_0:GetNextTime((arg_32_1 - 1) * 24 + arg_32_2, arg_32_3, arg_32_4, var_0_4)
end

function var_0_1.ParseTime(arg_33_0, arg_33_1)
...
function var_0_1.ParseTimeEx(arg_34_0, arg_34_1, arg_34_2)
...
function var_0_1.parseTimeFromConfig(arg_35_0, arg_35_1)
...
function var_0_1.DescDateFromConfig(arg_36_0, arg_36_1, arg_36_2)
	arg_36_2 = arg_36_2 or "%d.%02d.%02d"

	return string.format(arg_36_2, arg_36_1[1][1], arg_36_1[1][2], arg_36_1[1][3])
end

function var_0_1.DescCDTime(arg_37_0, arg_37_1)
...
function var_0_1.DescCDTimeForMinute(arg_38_0, arg_38_1)
...
function var_0_1.parseTimeFrom(arg_39_0, arg_39_1)
...
function var_0_1.inTime(arg_44_0, arg_44_1, arg_44_2)
	...
	if type(arg_44_1[1]) == "string" then
		arg_44_1 = {
			arg_44_1[2],
			arg_44_1[3]
		}
	...
	if var_44_1 and var_44_2 then
		...
		if var_44_4 < var_44_5 then
			return false, var_44_1
		end

		if var_44_6 < var_44_4 then
			return false, nil
		end
...
function var_0_1.passTime(arg_46_0, arg_46_1)
