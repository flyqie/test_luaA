...
function var_0_0.Init(arg_1_0, arg_1_1)
	...
	seriesAsync({
		function(arg_6_0)
			ResourceMgr.Inst:loadAssetBundleAsync("ui/commonui_atlas", function(arg_7_0)
		...
		function(arg_8_0)
			ResourceMgr.Inst:loadAssetBundleAsync("skinicon", function(arg_9_0)
		...
		function(arg_10_0)
			ResourceMgr.Inst:loadAssetBundleAsync("attricon", function(arg_11_0)
