...
slot2 = {
	...
	SC_64000_TECHSET_LIST_FIELD = slot0.FieldDescriptor(),
	...
	CS_64009_TECHSET_LIST_FIELD = slot0.FieldDescriptor(),
	SC_64010_RESULT_FIELD = slot0.FieldDescriptor(),
	...
	TECHSET_SHIP_TYPE_FIELD = slot0.FieldDescriptor(),
	TECHSET_ATTR_TYPE_FIELD = slot0.FieldDescriptor(),
	TECHSET_SET_VALUE_FIELD = slot0.FieldDescriptor()
}
...
slot2.SC_64000_TECHSET_LIST_FIELD.name = "techset_list"
slot2.SC_64000_TECHSET_LIST_FIELD.full_name = "p64.sc_64000.techset_list"
slot2.SC_64000_TECHSET_LIST_FIELD.number = 2
slot2.SC_64000_TECHSET_LIST_FIELD.index = 1
slot2.SC_64000_TECHSET_LIST_FIELD.label = 3
slot2.SC_64000_TECHSET_LIST_FIELD.has_default_value = false
slot2.SC_64000_TECHSET_LIST_FIELD.default_value = {}
slot2.SC_64000_TECHSET_LIST_FIELD.message_type = TECHSET
slot2.SC_64000_TECHSET_LIST_FIELD.type = 11
slot2.SC_64000_TECHSET_LIST_FIELD.cpp_type = 10
...
SC_64000.fields = {
	...
	slot2.SC_64000_TECHSET_LIST_FIELD
}
...
SC_64008.extensions = {}
slot2.CS_64009_TECHSET_LIST_FIELD.name = "techset_list"
slot2.CS_64009_TECHSET_LIST_FIELD.full_name = "p64.cs_64009.techset_list"
slot2.CS_64009_TECHSET_LIST_FIELD.number = 1
slot2.CS_64009_TECHSET_LIST_FIELD.index = 0
slot2.CS_64009_TECHSET_LIST_FIELD.label = 3
slot2.CS_64009_TECHSET_LIST_FIELD.has_default_value = false
slot2.CS_64009_TECHSET_LIST_FIELD.default_value = {}
slot2.CS_64009_TECHSET_LIST_FIELD.message_type = TECHSET
slot2.CS_64009_TECHSET_LIST_FIELD.type = 11
slot2.CS_64009_TECHSET_LIST_FIELD.cpp_type = 10
CS_64009.name = "cs_64009"
CS_64009.full_name = "p64.cs_64009"
CS_64009.nested_types = {}
CS_64009.enum_types = {}
CS_64009.fields = {
	slot2.CS_64009_TECHSET_LIST_FIELD
}
CS_64009.is_extendable = false
CS_64009.extensions = {}
slot2.SC_64010_RESULT_FIELD.name = "result"
slot2.SC_64010_RESULT_FIELD.full_name = "p64.sc_64010.result"
slot2.SC_64010_RESULT_FIELD.number = 1
slot2.SC_64010_RESULT_FIELD.index = 0
slot2.SC_64010_RESULT_FIELD.label = 2
slot2.SC_64010_RESULT_FIELD.has_default_value = false
slot2.SC_64010_RESULT_FIELD.default_value = 0
slot2.SC_64010_RESULT_FIELD.type = 13
slot2.SC_64010_RESULT_FIELD.cpp_type = 3
SC_64010.name = "sc_64010"
SC_64010.full_name = "p64.sc_64010"
SC_64010.nested_types = {}
SC_64010.enum_types = {}
SC_64010.fields = {
	slot2.SC_64010_RESULT_FIELD
}
...
slot2.TECHSET_SHIP_TYPE_FIELD.name = "ship_type"
slot2.TECHSET_SHIP_TYPE_FIELD.full_name = "p64.techset.ship_type"
slot2.TECHSET_SHIP_TYPE_FIELD.number = 1
slot2.TECHSET_SHIP_TYPE_FIELD.index = 0
slot2.TECHSET_SHIP_TYPE_FIELD.label = 2
slot2.TECHSET_SHIP_TYPE_FIELD.has_default_value = false
slot2.TECHSET_SHIP_TYPE_FIELD.default_value = 0
slot2.TECHSET_SHIP_TYPE_FIELD.type = 13
slot2.TECHSET_SHIP_TYPE_FIELD.cpp_type = 3
slot2.TECHSET_ATTR_TYPE_FIELD.name = "attr_type"
slot2.TECHSET_ATTR_TYPE_FIELD.full_name = "p64.techset.attr_type"
slot2.TECHSET_ATTR_TYPE_FIELD.number = 2
slot2.TECHSET_ATTR_TYPE_FIELD.index = 1
slot2.TECHSET_ATTR_TYPE_FIELD.label = 2
slot2.TECHSET_ATTR_TYPE_FIELD.has_default_value = false
slot2.TECHSET_ATTR_TYPE_FIELD.default_value = 0
slot2.TECHSET_ATTR_TYPE_FIELD.type = 13
slot2.TECHSET_ATTR_TYPE_FIELD.cpp_type = 3
slot2.TECHSET_SET_VALUE_FIELD.name = "set_value"
slot2.TECHSET_SET_VALUE_FIELD.full_name = "p64.techset.set_value"
slot2.TECHSET_SET_VALUE_FIELD.number = 3
slot2.TECHSET_SET_VALUE_FIELD.index = 2
slot2.TECHSET_SET_VALUE_FIELD.label = 2
slot2.TECHSET_SET_VALUE_FIELD.has_default_value = false
slot2.TECHSET_SET_VALUE_FIELD.default_value = 0
slot2.TECHSET_SET_VALUE_FIELD.type = 13
slot2.TECHSET_SET_VALUE_FIELD.cpp_type = 3
TECHSET.name = "techset"
TECHSET.full_name = "p64.techset"
TECHSET.nested_types = {}
TECHSET.enum_types = {}
TECHSET.fields = {
	slot2.TECHSET_SHIP_TYPE_FIELD,
	slot2.TECHSET_ATTR_TYPE_FIELD,
	slot2.TECHSET_SET_VALUE_FIELD
}
