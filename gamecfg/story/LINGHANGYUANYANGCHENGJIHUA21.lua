return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "呵呵……您怎么发出了那种像是上了年纪的爷爷奶奶才会发出的感慨呢？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "……您、您该不会觉得我很幼稚，还喜欢这种小孩子喜欢的东西吧……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_704",
			hidePaintObj = true,
			say = "毕竟，领航员小姐状态下的TB可不会主动向我提出“想坐旋转木马”这种请求。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
