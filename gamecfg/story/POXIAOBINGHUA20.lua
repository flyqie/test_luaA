return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 702040,
			dir = 1,
			say = "没错，不过据说皇家在更早的时候就开始使用计划舰这一称呼了哦。在不久之前的文件中对于{namecode:440}也采用了计划舰的称呼。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			side = 2,
			say = "{namecode:440}么……确实是一位资料极其匮乏的谜团一般的人物。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 702040,
			dir = 1,
			say = "在围剿{namecode:435}的战役结束后就立刻出现稳定了铁血局势，并将其最高权力牢牢掌控在手中的迷之铁血领导者，而皇家使用计划舰作为对其的定性。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
